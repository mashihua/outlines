...
<p>Just <a href="javascript:(function(){var s = document.createElement('script'),head = document.getElementsByTagName('head')&#91;0&#93;;head.appendChild(s);s.src='https://raw.github.com/mashihua/outlines/master/js/bookmarklet.js';}());">drag this link to bookmarks</a>.or add follow code:</p>
<pre>
